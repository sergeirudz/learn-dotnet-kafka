...
// MongoDB BSON is schemaless, flat binary. No inheritance like in .NET.
// EventData is seen as BaseEvent. It will serialize and create EventData with all keys.
// Otherwise, all events will be treated as BaseEvent
